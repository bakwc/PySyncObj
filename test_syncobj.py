...
def test_largeCommands():
	...
	o1 = TestObj(a[0], [a[1]], TEST_TYPE.COMPACTION_2, dumpFile = 'dump1.bin', leaderFallbackTimeout=10.0)
	o2 = TestObj(a[1], [a[0]], TEST_TYPE.COMPACTION_2, dumpFile = 'dump2.bin', leaderFallbackTimeout=10.0)
	objs = [o1, o2]
	doTicks(objs, 10, stopFunc=lambda: o1._isReady() and o2._isReady())
	...
	print(' === generated bigStr', round(time.time() - t1, 2))
	...
	print(' === replicated', round(time.time() - t1, 2))
